...
The commands below use <strong>vswhere</strong> to locate VS/BuildTools automatically, load the MSVC environment for the current terminal session, then build/run.
